...
describe('Reactivity Tracking in Constructors', () => {
    ...
    class Foo {
      static {
        ({
          ...
          c: [_Foo, _initClass]
        } = _applyDecs(this, [untracked], [[signal, 0, "amount"]]));
      }
      constructor() {
    ...
    class Bar extends (_Foo2 = _Foo) {
      static {
        ({
          ...
          c: [_Bar, _initClass2]
        } = _applyDecs(this, [untracked], [[signal, 0, "double"]], 0, void 0, _Foo2));
      }
  ...
  it('automatically does not track reactivity in constructors when using @reactive', () => {
    var _Foo4;
    let _initClass3, _init_amount2, _init_extra_amount2, _initClass4, _init_double2, _init_extra_double2;
    let _Foo3;
    class Foo {
      static {
        ({
          e: [_init_amount2, _init_extra_amount2],
          c: [_Foo3, _initClass3]
    ...
    let _Bar2;
    class Bar extends (_Foo4 = _Foo3) {
      static {
        ({
          e: [_init_double2, _init_extra_double2],
          c: [_Bar2, _initClass4]
        } = _applyDecs(this, [reactive], [[signal, 0, "double"]], 0, void 0, _Foo4));
      }
      double = _init_double2(this, 0);
      constructor() {
        super(), _init_extra_double2(this);
        this.double = this.amount * 2; // this read of .amount should not be tracked
      }
      static {
        _initClass4();
  ...
  it('automatically does not track reactivity in constructors when using @memo', () => {
    let _init_amount3, _init_extra_amount3, _initProto;
    class Foo {
      static {
        [_init_amount3, _init_extra_amount3] = _applyDecs(this, [], [[signal, 0, "amount"]]).e;
      }
      constructor() {
    ...
    class Bar extends Foo {
      static {
        [_initProto] = _applyDecs(this, [], [[memo, 3, "double"]], 0, void 0, Foo).e;
      }
      constructor(...args) {
        super(...args);
        _initProto(this);
...
//# sourceMappingURL=untracked.test.js.map