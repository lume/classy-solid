let _initProto, _init_foo, _init_extra_foo, _initProto2, _init_bar, _init_extra_bar;
...
class Foo {
  static {
    [_init_foo, _init_extra_foo, _initProto] = _applyDecs(this, [], [[signal, 0, "foo"], [signal, 3, "lorem"], [signal, 4, "lorem"]]).e;
  }
  constructor() {
...
class Bar extends Foo {
  static {
    [_init_bar, _init_extra_bar, _initProto2] = _applyDecs(this, [], [[signal, 0, "bar"], [signal, 3, "baz"], [signal, 4, "baz"], [effect, 2, "logFoo"], [effect, 2, "logLorem"], [effect, 2, "logBar"], [effect, 2, "logBaz"]], 0, void 0, Foo).e;
  }
  constructor(...args) {
    super(...args);
  ...
  #baz = (_initProto2(this), 789);
  bar = _init_bar(this, 456);
